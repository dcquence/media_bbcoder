...
Simply double-click the script to run, and follow the prompts. The bbcode output is dumped to a txt file in the same folder as teh script, using the name of the movie.
